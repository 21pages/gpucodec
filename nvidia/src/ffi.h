...
void* nvidia_new_encoder(int32_t device, int32_t format, int32_t codecID, int32_t width, int32_t height, int32_t pitchs[MAX_DATA_NUM]);
...
void* nvidia_new_decoder(int32_t device, int32_t format,int32_t codecID);
